...
$query = "SELECT id, username, email, role FROM testt WHERE role IN ('User') $search_query $role_query ORDER BY id $sort_order LIMIT $offset, $records_per_page";
$result = mysqli_query($connection, $query);

// Get total records for pagination
$total_query = "SELECT COUNT(*) AS total FROM testt WHERE role IN ('User') $search_query $role_query";
